    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        <div className={`rounded-lg p-3 text-center ${isFinalized ? 'bg-gray-100' : 'bg-gray-50'}`}>
          ...
          <div className="text-lg font-bold text-gray-900">{totalAmount.toFixed(2)} SAR</div>
        </div>
        <div className={`rounded-lg p-3 text-center ${isFinalized ? 'bg-gray-100' : 'bg-green-50'}`}>
          ...
          <div className={`text-lg font-bold ${isFinalized ? 'text-gray-700' : 'text-green-600'}`}>{paidAmount.toFixed(2)} SAR</div>
        </div>
